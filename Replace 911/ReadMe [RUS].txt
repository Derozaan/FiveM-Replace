...
Файлы "banshee.yft, banshee_hi.yft, banshee.ytd" - заменить по этим адресам:
\Grand Theft Auto V\mods\x64e.rpf\levels\gta5\vehicles.rpf\
\Grand Theft Auto V\mods\update\x64\dlcpacks\patchday1ng\dlc.rpf\x64\levels\gta5\vehicles.rpf\
-----------------------------------------------------------------------------------------------------------------------------------------
Настройки vehicles.meta
Grand Theft Auto V\mods\update\update.rpf\common\data\levels\gta5
    ...
    <Item>
      ...
      <audioNameHash>comet2</audioNameHash>
      <layout>LAYOUT_STD_HIGHWINDOW</layout>
      <coverBoundOffsets>HUNTLEY_COVER_OFFSET_INFO</coverBoundOffsets>
      ...
      <PovCameraOffset x="0.000000" y="-0.252000" z="0.590000" />
      ...
      <maxNum value="999" />
      <flags>FLAG_SPORTS FLAG_HAS_LIVERY FLAG_EXTRAS_STRONG FLAG_RICH_CAR FLAG_NO_BROKEN_DOWN_SCENARIO FLAG_HAS_INTERIOR_EXTRAS FLAG_RECESSED_TAILLIGHT_CORONAS</flags>
	  ...
	  <firstPersonDrivebyData>
        <Item>STD_FUGITIVE_FRONT_LEFT</Item>
        <Item>STD_PREMIER_FRONT_RIGHT</Item>
		<Item>STD_FUGITIVE_REAR_LEFT</Item>
		<Item>STD_FUGITIVE_REAR_RIGHT</Item>
      </firstPersonDrivebyData>
    </Item>


-----------------------------------------------------------------------------------------------------------------------------------------
В разделе - "<txdRelationships>" заменить на это:
...
-----------------------------------------------------------------------------------------------------------------------------------------
Настройки handling.meta
\Grand Theft Auto V\mods\update\update.rpf\common\data

     <Item type="CHandlingData">
      <handlingName>BANSHEE</handlingName>
      <fMass value="1990.000000" />
      <fInitialDragCoeff value="1.150000" />
      <fPercentSubmerged value="85.000000" />
      <vecCentreOfMassOffset x="0.000000" y="-0.300000" z="0.100000" />
      <vecInertiaMultiplier x="1.300000" y="1.100000" z="1.100000" />
      ...
      <fAntiRollBarBiasFront value="0.625000" />
...
Инструкция и настройки от: Alex9581 http://maniamods.ru/